...
class EmailSender
{
    ...
    public function submitEmail($name, $email, $message): string
    {
...
if (isset($_POST['name']) && isset($_POST['email']) && isset($_POST['message'])) {
    ...
    $response = $sender->submitEmail($_POST['name'], $_POST['email'], $_POST['message']);
        ...
        <div class="container" data-aos="fade-up">
            ...
            <div class="row mt-5">
                ...
                <div class="col-lg-8 mt-xxl-5">
                    ...
                    <form action="redirect.php" method="post" role="form" class="php-email-form">
                        <div class="row">
                        ...
                        <div class="form-group mt-3">
                            <label>
                                <textarea class="form-control" name="message" rows="5" cols="60" placeholder="Message" required></textarea>
                            </label>
                        </div>
                        <div class="my-3">
...
<!--//        echo 'Message submitted. We will be in touch';-->
<!--//        exit;-->
<!--//    }-->
<!--//    else-->
